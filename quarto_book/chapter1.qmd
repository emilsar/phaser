...
This chapter walks through building a simple 2D platformer in Phaser, from project setup through a playable game. Play the finished version below before reading the walkthrough — it is exactly what we are going to build.

---

## Play it

Move with **← →** (or **A** / **D**), jump with **↑** or **Space** (or **W**), and collect all five gold coins. The sliders below are wired directly to the variables in the source code — move one and watch the game respond instantly.
